            ...
            return (
              ...
              >
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noreferrer"
                  className="inline-flex items-center text-sm font-bold text-[var(--honda-red)] hover:text-[var(--honda-red-hover)] active:text-[var(--honda-red-hover)] active:-translate-y-[2px] active:drop-shadow-md transition-all duration-300 uppercase tracking-wider"
                >
                  {service.ctaText}
